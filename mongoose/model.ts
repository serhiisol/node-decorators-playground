import * as mongoose from '@decorators/mongoose/node_modules/mongoose';
import { SchemaField, Model, Static, Instance, Hook, model } from '@decorators/mongoose';
import { Container, Injectable, Inject, InjectionToken } from '@decorators/mongoose/node_modules/@decorators/di';
